...
window.EV_FILTERS = (() => {
  ...
  const COLUMNS = [
    ...
    { key: 'flow',   label: 'Flow',      align: 'c', kind: 'fbar',   get: r => r.fStr.flow, numeric: true, defVisible: true },
    { key: 'dorm',   label: 'Dorm',      align: 'c', kind: 'fbar',   get: r => r.fStr.dorm, numeric: true, defVisible: true },
    { key: 'sent',   label: 'Sentiment', align: 'c', kind: 'fbar',   get: r => r.fStr.sent, numeric: true, defVisible: true },
